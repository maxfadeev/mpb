...
<html>
    ...
    <?php foreach ($users as $user) { ?>
        <p><?php echo $user->login; ?>
            <a href="<?php echo $this->url->get('/users/delete/id'); ?>/<?php echo $user->id; ?>/<?php echo $token; ?>">delete</a>
            <a href="<?php echo $this->url->get('/users/edit/id'); ?>/<?php echo $user->id; ?>">edit</a>
        </p>
    <?php } ?>
